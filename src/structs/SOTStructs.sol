...
/**
    ...
    * maxSqrtOracleDeviationBips: Maximum deviation in basis points allowed between spot and oracle price.
...
struct SolverReadSlot {
    ...
    uint16 maxSqrtOracleDeviationBips;
...
struct SOTConstructorArgs {
    ...
    uint16 maxSqrtOracleDeviationBound;
