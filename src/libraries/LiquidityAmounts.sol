...
library LiquidityAmounts {
    ...
    function getLiquidityForAmount0(
        ...
        unchecked {
            return capToUint128(FullMath.mulDiv(amount0, intermediate, sqrtRatioBX96 - sqrtRatioAX96));
        }
    }
    ...
    function getLiquidityForAmount1(
        ...
        unchecked {
            return capToUint128(FullMath.mulDiv(amount1, FixedPoint96.Q96, sqrtRatioBX96 - sqrtRatioAX96));
        }
    }
